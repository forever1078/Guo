...
while(1):
    if(cv.waitKey(2)==99):
        ...
        cv.rectangle(frame, (250,250), (100,100), (0,255,0),0)
        crop_frame=frame[100:250,100:250]
         #Blur the image
...
#        res_size=cv.resize(image_YCbCr,(80,80))
        ...
        res_size=cv.resize(imgSkin,(20,20))
        cv.imwrite(os.path.join('./hand',"gest"+str(i)+".jpg"),res_size)
